                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('date_start') is-invalid @enderror"
                                        id="date_start" type="date" name="date_start" value="{{ old('date_start') }}">
                                    @error('date_start')
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('date_end') is-invalid @enderror" id="date_end"
                                        type="date" name="date_end" value="{{ old('date_end') }}">
                                    @error('date_end')
                                    <span class="text-danger" role="alert">
                                        <small><strong>{{ $message }}</strong></small>
                                    </span>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('partner') is-invalid @enderror" id="partner"
                                        type="text" name="partner" value="{{ old('partner') }}">
                                    @error('partner')
                                    <span class="text-danger" role="alert">
                                        <small><strong>{{ $message }}</strong></small>
                                    </span>
                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('notes') is-invalid @enderror" id="notes"
                                        rows="5" name="notes">{{ old('notes') }}</textarea>
                                    @error('notes')
                                    <span class="text-danger" role="alert">
                                        <small><strong>{{ $message }}</strong></small>
                                    </span>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <select name="status" class="form-control  @error('status ') is-invalid @enderror">
                                        ...
                                        <option value="soon" {{ old('status')=='soon' ? 'selected' : '' }}>Akan Datang</option>
                                    </select>
                                    @error('gender')
                                    <span class="text-danger" role="alert">
                                        <small><strong>{{ $message }}</strong></small>
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('total_male') is-invalid @enderror"
                                        id="total-male" type="number" name="total_male" value="{{ old('total_male') }}">
                                    @error('total_male')
                                    <span class="text-danger" role="alert">
                                        <small><strong>{{ $message }}</strong></small>
                                    </span>
