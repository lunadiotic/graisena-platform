                            ...
                            <div class="col-lg-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control @error('name') is-invalid @enderror" type="text"
                                        name="name" id="name" value="{{ old('name') }}" required autocomplete="name"
                                        autofocus>
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status_of_marital" id="status_of_marital"
                                        ...
                                        <option value="w" {{ old('status_of_marital')=='w' ? 'selected' : '' }}>Cerai
                                            Mati
                                        </option>
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="status_of_job" id="status_of_job"
                                        ...
                                        <option value="s" {{ old('status_of_job')=='s' ? 'selected' : '' }}>Pelajar
                                        </option>
                                        <option value="w" {{ old('status_of_job')=='w' ? 'selected' : '' }}>Bekerja
                                        </option>
                                        <option value="n" {{ old('status_of_job')=='n' ? 'selected' : '' }}>Tidak
                                            Bekerja
                                        </option>
                                    </select>
                                    @error('status_of_job')
